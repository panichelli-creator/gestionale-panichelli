                ...
                >
                  ...
                  <td className="tdDate">
                    <div className="dateCell">
                      <input
                        ...
                        onChange={(e) =>
                          updateField(r.id, "dataUltimoAppuntamento", e.target.value)
                        }
                  ...
                  <td className="tdDate">
                    <input
                      ...
                      onChange={(e) =>
                        updateField(r.id, "dataAppuntamentoPreso", e.target.value)
                      }
                    />
                  </td>
                  ...
                  <td className="tdCenter">
                    <button
                      ...
                      disabled={isBusy}
                      onClick={() =>
                        toggleField(r.id, "verificheEseguite", !r.verificheEseguite)
                      }
                      className={`actionChip ${
                        r.verificheEseguite ? "actionGreen" : "actionGray"
                      }`}
                  ...
                  <td className="tdCenter">
                    <button
                      ...
                      className={`actionChip ${
                        r.fileSuDropbox ? "actionBlue" : "actionGray"
                      }`}
                  ...
                  <td className="tdCenter">
                    <button
                      ...
                      disabled={isBusy}
                      onClick={() =>
                        toggleField(r.id, "tecnicoFatturato", !Boolean(r.tecnicoFatturato))
                      }
                      className={`actionChip ${
                        r.tecnicoFatturato ? "actionBlue" : "actionGray"
                      }`}
